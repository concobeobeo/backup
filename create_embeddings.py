...
def create_model(Input) : #tách đặc trưng ảnh dùng cnn
    #zeroPadding ảnh 96x96x3 với padding=3x3
      x = ZeroPadding2D(padding=(3, 3), input_shape=(96, 96, 3))(Input)
    # tạo ra layer 48x48x64 khi tính chập ảnh với 64 kernel 7x7 trượt 2 -> giảm kích thước ảnh xuống 1 nửa
      x = Conv2D(64, (7, 7), strides=(2, 2), name='conv1')(x)
      #chuẩn hóa dữ liệu của lớp conv1, đưa means về 0.00001 hỗ trợ gradient descent để tăng tốc độ learning.
      x = BatchNormalization(axis=3,epsilon=0.00001, name='bn1')(x)
      #hàm kích hoạt relu = max(0,x)
      x = Activation('relu')(x)
    #zero padding để chuẩn bị cho max pooling
      x = ZeroPadding2D(padding=(1, 1))(x)
    #max pooling kích thước 3x3, trượt 2 giảm kích thước ảnh xuống 1 nửa với 64 channels 24x24
    ...
    #tạo mạng neurals fully connected với 128 neurals
...
if __name__ == "__main__" :
    ...
    #Loads a classifier from xml file.
