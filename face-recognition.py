      ...
      while True :
            ...
            for (x, y, w, h) in faces:
                  ...
                  if identity is not None:
                        ...
                        cv2.putText(image, str(identity).title(), (x+5,y-5), font, 0.5, (0, 255, 0), 2)
                  elif identity is None:
                        cv2.rectangle(image, (x, y), (x + w, y + h), (0, 0, 255), 1)
                        cv2.putText(image, str("Unknown").title(), (x + 5, y - 5), font, 0.5, (0, 0, 255), 2)
...
def load_embeddings() :
      input_embeddings = {}
      embedding_file = np.load('C:/Users/NGUYEN DUY LINH/Desktop/face-recognition-cnn-master/embeddings.npy',allow_pickle=True)
